...
module Network.Mosquitto.LowLevel.Functions where

import           Foreign.C
import           Foreign.C.String
import           Foreign.Ptr
import           Network.Mosquitto.LowLevel.Types
...
--
-- libmosq_EXPORT int mosquitto_lib_version(intmajor, intminor, intrevision);
foreign import ccall unsafe "mosquitto.h mosquitto_lib_version" c_lib_version :: Ptr CInt -> Ptr CInt -> Ptr CInt -> IO CInt

-- | Function: mosquitto_lib_init
--
-- Must be called before any other mosquitto functions.
--
-- This function isnot* thread safe.
--
-- Returns:
...
foreign import ccall safe "mosquitto.h mosquitto_lib_init" c_mosquitto_lib_init :: IO CInt
...
foreign import ccall unsafe "mosquitto.h mosquitto_lib_cleanup" c_lib_cleanup :: IO CInt
...
--
-- libmosq_EXPORT struct mosquittomosquitto_new(const charid, bool clean_session, voidobj);
foreign import ccall unsafe "mosquitto.h mosquitto_new" c_new :: CString -> Bool -> Ptr () -> IO (Ptr Mosquitto)
...
--
-- libmosq_EXPORT void mosquitto_destroy(struct mosquittomosq);
foreign import ccall unsafe "mosquitto.h mosquitto_destroy" c_destroy :: Ptr Mosquitto -> IO ()
...
--
-- libmosq_EXPORT int mosquitto_reinitialise(struct mosquittomosq, const charid, bool clean_session, voidobj);
foreign import ccall unsafe "mosquitto.h mosquitto_reinitialise" c_mosquitto_reinitialise :: Ptr Mosquitto -> CString -> Bool -> Ptr () -> IO CInt
...
--
-- libmosq_EXPORT int mosquitto_will_set(struct mosquittomosq, const chartopic, int payloadlen, const voidpayload, int qos, bool retain);
foreign import ccall unsafe "mosquitto.h mosquitto_will_set" c_mosquitto_will_set :: Ptr Mosquitto -> CString -> CInt -> Ptr () -> CInt -> Bool -> IO CInt
...
-- MOSQ_ERR_INVAL -   if the input parameters were invalid.
--
-- libmosq_EXPORT int mosquitto_will_clear(struct mosquittomosq);
foreign import ccall unsafe "mosquitto.h mosquitto_will_clear" c_mosquitto_will_clear :: Ptr Mosquitto -> IO CInt
...
-- MOSQ_ERR_NOMEM -   if an out of memory condition occurred.
--
-- libmosq_EXPORT int mosquitto_username_pw_set(struct mosquittomosq, const charusername, const charpassword);
foreign import ccall unsafe "mosquitto.h mosquitto_username_pw_set" c_mosquitto_username_pw_set :: Ptr Mosquitto -> CString -> CString -> IO CInt
...
--
-- libmosq_EXPORT int mosquitto_connect(struct mosquittomosq, const charhost, int port, int keepalive);
foreign import ccall unsafe "mosquitto.h mosquitto_connect" c_mosquitto_connect :: Ptr Mosquitto -> CString -> CInt -> CInt -> IO CInt
...
--
-- libmosq_EXPORT int mosquitto_connect_bind(struct mosquittomosq, const charhost, int port, int keepalive, const charbind_address);
foreign import ccall unsafe "mosquitto.h mosquitto_connect_bind" c_mosquitto_connect_bind :: Ptr Mosquitto -> CString -> CInt -> CInt -> CString -> IO CInt
...
--
-- libmosq_EXPORT int mosquitto_connect_async(struct mosquittomosq, const charhost, int port, int keepalive);
foreign import ccall unsafe "mosquitto.h mosquitto_connect_async" c_mosquitto_connect_async :: Ptr Mosquitto -> CString -> CInt -> CInt -> IO CInt
...
--
-- libmosq_EXPORT int mosquitto_connect_bind_async(struct mosquittomosq, const charhost, int port, int keepalive, const charbind_address);
foreign import ccall unsafe "mosquitto.h mosquitto_connect_bind_async" c_mosquitto_connect_bind_async :: Ptr Mosquitto -> CString -> CInt -> CInt -> CString -> IO CInt
...
-- <mosquitto_connect_async>, <mosquitto_connect>, <mosquitto_connect_bind>
--
-- libmosq_EXPORT int mosquitto_connect_srv(struct mosquittomosq, const charhost, int keepalive, const charbind_address);
foreign import ccall unsafe "mosquitto.h mosquitto_connect_srv" c_mosquitto_connect_srv :: Ptr Mosquitto -> CString -> CInt -> CString -> IO CInt
...
--
-- libmosq_EXPORT int mosquitto_reconnect(struct mosquittomosq);
foreign import ccall unsafe "mosquitto.h mosquitto_reconnect" c_mosquitto_reconnect :: Ptr Mosquitto -> IO CInt
...
--
-- libmosq_EXPORT int mosquitto_reconnect_async(struct mosquittomosq);
foreign import ccall unsafe "mosquitto.h mosquitto_reconnect_async" c_mosquitto_reconnect_async :: Ptr Mosquitto -> IO CInt
...
--
-- libmosq_EXPORT int mosquitto_disconnect(struct mosquittomosq);
...
--
-- libmosq_EXPORT int mosquitto_publish(struct mosquittomosq, intmid, const chartopic, int payloadlen, const voidpayload, int qos, bool retain);
foreign import ccall unsafe "mosquitto.h mosquitto_publish" c_mosquitto_publish :: Ptr Mosquitto -> Ptr CInt -> CString -> CInt -> Ptr () -> CInt -> Bool -> IO CInt
...
-- MOSQ_ERR_NO_CONN - if the client isn't connected to a broker.
--
-- libmosq_EXPORT int mosquitto_subscribe(struct mosquittomosq, intmid, const charsub, int qos);
foreign import ccall unsafe "mosquitto.h mosquitto_subscribe" c_mosquitto_subscribe :: Ptr Mosquitto -> Ptr CInt -> CString -> CInt -> IO CInt
...
-- MOSQ_ERR_NO_CONN - if the client isn't connected to a broker.
--
-- libmosq_EXPORT int mosquitto_unsubscribe(struct mosquittomosq, intmid, const charsub);
foreign import ccall unsafe "mosquitto.h mosquitto_unsubscribe" c_mosquitto_unsubscribe :: Ptr Mosquitto -> Ptr CInt -> CString -> IO CInt
...
--
-- libmosq_EXPORT int mosquitto_message_copy(struct mosquitto_messagedst, const struct mosquitto_messagesrc);
foreign import ccall unsafe "mosquitto.h mosquitto_message_copy" c_mosquitto_message_copy :: Ptr MosquittoMessage -> Ptr MosquittoMessage -> IO CInt
...
foreign import ccall unsafe "mosquitto.h mosquitto_message_free" c_mosquitto_message_free :: Ptr MosquittoMessage -> IO ()
...
--
-- libmosq_EXPORT int mosquitto_loop(struct mosquittomosq, int timeout, int max_packets);
foreign import ccall unsafe "mosquitto.h mosquitto_loop" c_mosquitto_loop :: Ptr MosquittoMessage -> CInt -> CInt -> IO CInt
...
--
-- libmosq_EXPORT int mosquitto_loop_forever(struct mosquittomosq, int timeout, int max_packets);
foreign import ccall unsafe "mosquitto.h mosquitto_loop_forever" c_mosquitto_loop_forever :: Ptr MosquittoMessage -> CInt -> CInt -> IO CInt
...
--
-- libmosq_EXPORT int mosquitto_loop_start(struct mosquittomosq);
foreign import ccall unsafe "mosquitto.h mosquitto_loop_start" c_mosquitto_loop_start :: Ptr MosquittoMessage -> IO CInt
...
-- <mosquitto_loop>, <mosquitto_loop_start>
--
-- libmosq_EXPORT int mosquitto_loop_stop(struct mosquittomosq, bool force);
foreign import ccall unsafe "mosquitto.h mosquitto_loop_stop" c_mosquitto_loop_stop :: Ptr Mosquitto -> Bool -> IO CInt
...
--
-- libmosq_EXPORT int mosquitto_socket(struct mosquittomosq);
foreign import ccall unsafe "mosquitto.h mosquitto_socket" c_mosquitto_socket :: Ptr MosquittoMessage -> IO CInt
...
--
-- libmosq_EXPORT int mosquitto_loop_read(struct mosquittomosq, int max_packets);
foreign import ccall unsafe "mosquitto.h mosquitto_loop_read" c_mosquitto_loop_read :: Ptr Mosquitto -> CInt -> IO CInt
...
--
-- libmosq_EXPORT int mosquitto_loop_write(struct mosquittomosq, int max_packets);
foreign import ccall unsafe "mosquitto.h mosquitto_loop_write" c_mosquitto_loop_write :: Ptr Mosquitto -> CInt -> IO CInt
...
--
-- libmosq_EXPORT int mosquitto_loop_misc(struct mosquittomosq);
foreign import ccall unsafe "mosquitto.h mosquitto_loop_misc" c_mosquitto_loop_misc :: Ptr Mosquitto -> IO CInt
...
-- <mosquitto_socket>, <mosquitto_loop_read>, <mosquitto_loop_write>
--
-- libmosq_EXPORT bool mosquitto_want_write(struct mosquittomosq);
foreign import ccall unsafe "mosquitto.h mosquitto_want_write" c_mosquitto_want_write :: Ptr Mosquitto -> IO Bool
...
--
-- libmosq_EXPORT int mosquitto_threaded_set(struct mosquittomosq, bool threaded);
foreign import ccall unsafe "mosquitto.h mosquitto_threaded_set" c_mosquitto_threaded_set :: Ptr Mosquitto -> Bool -> IO CInt
...
--                             MQTT_PROTOCOL_V31.
--
-- libmosq_EXPORT int mosquitto_opts_set(struct mosquittomosq, enum mosq_opt_t option, voidvalue);
foreign import ccall unsafe "mosquitto.h mosquitto_opts_set" c_mosquitto_opts_set :: Ptr Mosquitto -> CInt -> Ptr () -> IO CInt
...
--
-- libmosq_EXPORT int mosquitto_tls_set(struct mosquittomosq,
type PWCallback = FunPtr (CString -> CInt -> CInt -> Ptr () -> IO CInt)
foreign import ccall unsafe "mosquitto.h mosquitto_tls_set" c_mosquitto_tls_set :: Ptr Mosquitto -> CString -> CString -> CString -> CString -> PWCallback -> IO CInt
...
-- <mosquitto_tls_set>
--
-- libmosq_EXPORT int mosquitto_tls_insecure_set(struct mosquittomosq, bool value);
foreign import ccall unsafe "mosquitto.h mosquitto_tls_insecure_set" c_mosquitto_tls_insecure_set :: Ptr Mosquitto -> Bool -> IO CInt
...
-- <mosquitto_tls_set>
--
-- libmosq_EXPORT int mosquitto_tls_opts_set(struct mosquittomosq, int cert_reqs, const chartls_version, const charciphers);
foreign import ccall unsafe "mosquitto.h mosquitto_tls_opts_set" c_mosquitto_tls_opts_set :: Ptr Mosquitto -> CInt -> CString -> CString -> IO CInt
...
-- <mosquitto_tls_set>
--
-- libmosq_EXPORT int mosquitto_tls_psk_set(struct mosquittomosq, const charpsk, const charidentity, const charciphers);
foreign import ccall unsafe "mosquitto.h mosquitto_tls_psk_set" c_mosquitto_tls_psk_set :: Ptr Mosquitto -> CString -> CString -> CString -> IO CInt
...
--               void callback(struct mosquittomosq, voidobj, int rc)
--
-- Callback Parameters:
...
--
-- libmosq_EXPORT void mosquitto_connect_callback_set(struct mosquittomosq, void (*on_connect)(struct mosquitto, void, int));
type ConnectCallback = FunPtr (Ptr Mosquitto -> Ptr () -> CInt -> IO ())
foreign import ccall unsafe "mosquitto.h mosquitto_connect_callback_set" c_mosquitto_connect_callback_set :: Ptr Mosquitto -> ConnectCallback -> IO ()
...
--                  void callback(struct mosquittomosq, voidobj)
--
-- Callback Parameters:
--  mosq - the mosquitto instance making the callback.
--  obj -  the user data provided in <mosquitto_new>
...
--
-- libmosq_EXPORT void mosquitto_disconnect_callback_set(struct mosquittomosq, void (*on_disconnect)(struct mosquitto, void, int));
type DisconnectCallback = FunPtr (Ptr Mosquitto -> Ptr () -> CInt -> IO ())
foreign import ccall unsafe "mosquitto.h mosquitto_disconnect_callback_set" c_mosquitto_disconnect_callback_set :: Ptr Mosquitto -> DisconnectCallback -> IO ()
...
--               void callback(struct mosquittomosq, voidobj, int mid)
--
-- Callback Parameters:
--  mosq - the mosquitto instance making the callback.
--  obj -  the user data provided in <mosquitto_new>
...
--
-- libmosq_EXPORT void mosquitto_publish_callback_set(struct mosquittomosq, void (*on_publish)(struct mosquitto, void, int));
type PublishCallback = FunPtr (Ptr Mosquitto -> Ptr () -> CInt -> IO ())
foreign import ccall unsafe "mosquitto.h mosquitto_publish_callback_set" c_mosquitto_publish_callback_set :: Ptr Mosquitto -> PublishCallback -> IO ()
...
--               void callback(struct mosquittomosq, voidobj, const struct mosquitto_messagemessage)
--
-- Callback Parameters:
--  mosq -    the mosquitto instance making the callback.
--  obj -     the user data provided in <mosquitto_new>
...
-- <mosquitto_message_copy>
--
-- libmosq_EXPORT void mosquitto_message_callback_set(struct mosquittomosq, void (*on_message)(struct mosquitto, void, const struct mosquitto_message));
type MessageCallback = FunPtr (Ptr Mosquitto -> Ptr () -> Ptr MosquittoMessage -> IO ())
foreign import ccall unsafe "mosquitto.h mosquitto_message_callback_set" c_mosquitto_message_callback_set :: Ptr Mosquitto -> MessageCallback -> IO ()
...
--                 void callback(struct mosquittomosq, voidobj, int mid, int qos_count, const intgranted_qos)
--
-- Callback Parameters:
--  mosq -        the mosquitto instance making the callback.
--  obj -         the user data provided in <mosquitto_new>
...
--                the subscriptions.
--
-- libmosq_EXPORT void mosquitto_subscribe_callback_set(struct mosquittomosq, void (*on_subscribe)(struct mosquitto, void, int, int, const int));
type SubscribeCallback = FunPtr (Ptr Mosquitto -> Ptr () -> CInt -> CInt -> Ptr CInt -> IO ())
foreign import ccall unsafe "mosquitto.h mosquitto_subscribe_callback_set" c_mosquitto_subscribe_callback_set :: Ptr Mosquitto -> SubscribeCallback -> IO ()
...
--
-- libmosq_EXPORT void mosquitto_unsubscribe_callback_set(struct mosquittomosq, void (*on_unsubscribe)(struct mosquitto, void, int));
type UnsubscribeCallback = FunPtr (Ptr Mosquitto -> Ptr () -> CInt -> IO ())
foreign import ccall unsafe "mosquitto.h mosquitto_unsubscribe_callback_set" c_mosquitto_unsubscribe_callback_set :: Ptr Mosquitto -> UnsubscribeCallback -> IO ()
...
--           void callback(struct mosquittomosq, voidobj, int level, const charstr)
--
-- Callback Parameters:
--  mosq -  the mosquitto instance making the callback.
--  obj -   the user data provided in <mosquitto_new>
...
--
-- libmosq_EXPORT void mosquitto_log_callback_set(struct mosquittomosq, void (*on_log)(struct mosquitto, void, int, const char));
type LogCallback = FunPtr (Ptr Mosquitto -> Ptr () -> CInt -> CString -> IO ())
foreign import ccall unsafe "mosquitto.h mosquitto_log_callback_set" c_mosquitto_log_callback_set :: Ptr Mosquitto -> LogCallback -> IO ()
...
-- MOSQ_ERR_INVAL -   if the input parameters were invalid.
--
-- libmosq_EXPORT int mosquitto_reconnect_delay_set(struct mosquittomosq, unsigned int reconnect_delay, unsigned int reconnect_delay_max, bool reconnect_exponential_backoff);
foreign import ccall unsafe "mosquitto.h mosquitto_reconnect_delay_set" c_mosquitto_reconnect_delay_set :: Ptr Mosquitto -> CUInt -> CUInt -> Bool -> IO CInt
...
-- MOSQ_ERR_INVAL -   if the input parameters were invalid.
--
-- libmosq_EXPORT int mosquitto_max_inflight_messages_set(struct mosquittomosq, unsigned int max_inflight_messages);
foreign import ccall unsafe "mosquitto.h mosquitto_max_inflight_messages_set" c_mosquitto_max_inflight_messages_set :: Ptr Mosquitto -> CUInt -> IO CInt
...
--
-- libmosq_EXPORT void mosquitto_message_retry_set(struct mosquittomosq, unsigned int message_retry);
foreign import ccall unsafe "mosquitto.h mosquitto_message_retry_set" c_mosquitto_message_retry_set :: Ptr Mosquitto -> CUInt -> IO ()
...
--        that are specified.
--
-- libmosq_EXPORT void mosquitto_user_data_set(struct mosquittomosq, voidobj);
foreign import ccall unsafe "mosquitto.h mosquitto_user_data_set" c_mosquitto_user_data_set :: Ptr Mosquitto -> Ptr () -> IO ()
...
--
-- libmosq_EXPORT const charmosquitto_strerror(int mosq_errno);
...
--
-- libmosq_EXPORT const charmosquitto_connack_string(int connack_code);
...
--
-- libmosq_EXPORT int mosquitto_sub_topic_tokenise(const charsubtopic, char**topics, intcount);
...
-- MOSQ_ERR_NOMEM -   if an out of memory condition occurred.
--
-- libmosq_EXPORT int mosquitto_topic_matches_sub(const charsub, const chartopic, boolresult);
...
--
-- libmosq_EXPORT int mosquitto_pub_topic_check(const chartopic);
...
--   <mosquitto_sub_topic_check>
--
-- libmosq_EXPORT int mosquitto_sub_topic_check(const chartopic);
